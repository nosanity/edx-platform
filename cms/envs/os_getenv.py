...
THIRD_PARTY_AUTH_BACKENDS_DEFAULT = THIRD_PARTY_AUTH_BACKENDS if THIRD_PARTY_AUTH_BACKENDS in locals() else []

THIRD_PARTY_AUTH_BACKENDS_OS = []
THIRD_PARTY_AUTH_BACKENDS_LMS = os.getenv('THIRD_PARTY_AUTH_BACKENDS_LMS', locals().get('THIRD_PARTY_AUTH_BACKENDS_LMS'))
if THIRD_PARTY_AUTH_BACKENDS_LMS:
    THIRD_PARTY_AUTH_BACKENDS_OS.append(THIRD_PARTY_AUTH_BACKENDS_LMS)
THIRD_PARTY_AUTH_BACKENDS_CMS = os.getenv('THIRD_PARTY_AUTH_BACKENDS_CMS', locals().get('THIRD_PARTY_AUTH_BACKENDS_CMS'))
