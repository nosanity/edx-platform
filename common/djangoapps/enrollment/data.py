...
def create_course_enrollment(username, course_id, mode, is_active, course_shift_id=None):
    ...
    try:
        enrollment = CourseEnrollment.enroll(user, course_key, check_access=True, course_shift_id=course_shift_id)
