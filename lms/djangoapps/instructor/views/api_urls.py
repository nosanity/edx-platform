...
urlpatterns = [
    ...
    url(r'^list_scheduled_emails', api.list_scheduled_emails, name='list_scheduled_emails'),
    url(r'^remove_scheduled_email', api.remove_scheduled_email, name='remove_scheduled_email'),
