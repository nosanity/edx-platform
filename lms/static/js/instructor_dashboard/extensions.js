        ...
        function extensions($section) {
            ...
            this.$reset_due_date.click(function() {
                ...
                return $.ajax({
                    ...
                    error: function(xhr) {
                        return ext.fail_with_error('reset-extension', gettext('Error changing due date'), xhr);
                    }
                });
            });
            this.$show_unit_ext.click(function() {
                ...
                return $.ajax({
                    ...
                    data: sendData,
                    error: function(xhr) {
                        return ext.fail_with_error('view-granted-extensions', gettext('Error changing due date'), xhr);
                    },
                    success: function(data) {
