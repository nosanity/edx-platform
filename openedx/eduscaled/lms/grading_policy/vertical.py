...
log = logging.getLogger("openedx.eduscaled.lms.grading_policy")
        ...
        for assignment_type, assignment_info in graded_assignments.iteritems():
            for vertical_location in assignment_info['vertical_headers']:
                try:
                    ...
                    if vertical_grade.graded_total.first_attempted is not None:
                        grade_result = vertical_grade.graded_total.earned / vertical_grade.graded_total.possible
                    else:
